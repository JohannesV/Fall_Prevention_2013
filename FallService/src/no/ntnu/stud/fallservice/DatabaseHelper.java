...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		final String CREATE_TABLE_1 = 
				...
				DatabaseContract.Movement.COLUMN_NAME_TIMESTAMP + " date PRIMARY KEY," +
	...
	public List<Movement> dbGetEventList() {
		...
		for (int i = 0; i < c.getCount(); i++) {
			...
			Movement m = new Movement(Helper.parseDate(c.getString(0)), Double.parseDouble(c.getString(1)), Double.parseDouble(c.getString(2)), Double.parseDouble(c.getString(3)));
			movements.add(m);
		}

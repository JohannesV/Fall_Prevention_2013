...
\begin{itemize}
\item Measure gait speed: The application shall be able to detect the speed of the users gait so that this information can used as a element in the whole detection process.
\item Measure gait variability: The application shall be able to detect the variability of the users gait. That will be one of the main part for understanding its fallbehaviour and the reasons of his falling down.
